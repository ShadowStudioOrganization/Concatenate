...
open class MinecraftClientLauncher(
    ...
    override fun launch(): Process {
        proc: Process
    // Joint parameter
    title: String = "title 启动 - flandrebakapack-1.20.1"
    echo: String = "echo 游戏正在启动，请稍候。"
    set: String = "set APPDATA=\""+ workingDirectory +"\""
    cd: String = "cd /D\""+ workingDirectory +"\""
    parameter: String = "off" + title + echo + set + cd
        + "
        \"" + environments + "\"" ^ + "
        -XX:+UseG1GC ^
        ...
        --gameDir \"" + workingDirectory + "versions\flandrebakapack-1.20.1" ^
        --assetsDir \"" + workingDirectory + "assets" ^
        --assetIndex 5 ^
        --uuid 025b2f68b7254e27a5597833e089efe5 ^
        --accessToken -ghw ^
        --clientId ${clientid} ^
        --xuid ${auth_xuid} ^
        --userType msa ^
        --versionType PCL ^
    ...
    // Excu echo
        proc.excu(new String[]{"@echo", parameter})
